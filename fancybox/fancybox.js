!(
	/*! License details at fancyapps.com/license */ (function (e, t) {
		...
		let N = (e) => {
			...
			G = (e, t) => {
				...
				function P(e) {
					...
					let p = Date.now(),
						m = p - (f || p);
					(d = m > 0 && m <= 250), (f = p), clearTimeout(x), (i = e), e instanceof MouseEvent && (window.addEventListener("mousemove", C), window.addEventListener("mouseup", O)), window.addEventListener("blur", A), (a = [...(r = D(e))]), (s = []), (g = r.length), (n = V(r)), 1 === g && ((c = !1), (u = !1)), g && T(V(r)), S("start");
				}
				function C(e) {
					...
					if (((p = t.x - u.x), (m = t.y - u.y), T(t), R(), S("move"), r.length > 1 && Math.abs(j(r) - j(s)) >= 0.1 && S("pinch"), !c && a.length)) {
						let e = V(a);
						(h = t.x - e.x), (v = t.y - e.y), (c = Math.abs(h) > l.panThreshold || Math.abs(v) > l.panThreshold) && ((Z = !1), clearTimeout(M), (M = 0), (o = (E = Math.abs((180 * Math.atan2(v, h)) / Math.PI)) > 45 && E < 135 ? "y" : "x"), (a = [...r]), (s = [...r]), window.getSelection()?.removeAllRanges(), S("panstart"));
					}
					c && (p || m) && S("pan");
				}
				function O(e) {
				...
				let I = {
					init: function () {
						if (e) return e.addEventListener("click", k, q), e.addEventListener("mousedown", P, q), e.addEventListener("touchstart", P, q), e.addEventListener("touchmove", C, q), e.addEventListener("touchend", O), e.addEventListener("touchcancel", O), I;
					},
					on: function (e, t) {
					...
					isPointerDown: () => g > 0,
					destroy: function () {
						clearTimeout(x), clearTimeout(M), (M = 0), e && (e.removeEventListener("click", k, q), e.removeEventListener("mousedown", P, q), e.removeEventListener("touchstart", P, q), e.removeEventListener("touchmove", C, q), e.removeEventListener("touchend", O), e.removeEventListener("touchcancel", O)), (e = null), z();
					},
				};
				return I;
			};
		...
		let Y = { IMAGE_ERROR: "This image couldn't be loaded. <br /> Please try again later.", MOVE_UP: "Move up", MOVE_DOWN: "Move down", MOVE_LEFT: "Move left", MOVE_RIGHT: "Move right", ZOOM_IN: "Zoom in", ZOOM_OUT: "Zoom out", TOGGLE_FULL: "Toggle zoom level", TOGGLE_1TO1: "Toggle zoom level", ITERATE_ZOOM: "Toggle zoom level", ROTATE_CCW: "Rotate counterclockwise", ROTATE_CW: "Rotate clockwise", FLIP_X: "Flip horizontally", FLIP_Y: "Flip vertically", RESET: "Reset" },
			...
			J = (((S = {}).Reset = "reset"), (S.Zoom = "zoom"), (S.ZoomIn = "zoomIn"), (S.ZoomOut = "zoomOut"), (S.ZoomTo = "zoomTo"), (S.ToggleCover = "toggleCover"), (S.ToggleFull = "toggleFull"), (S.ToggleMax = "toggleMax"), (S.IterateZoom = "iterateZoom"), (S.Pan = "pan"), (S.Swipe = "swipe"), (S.Move = "move"), (S.MoveLeft = "moveLeft"), (S.MoveRight = "moveRight"), (S.MoveUp = "moveUp"), (S.MoveDown = "moveDown"), (S.RotateCCW = "rotateCCW"), (S.RotateCW = "rotateCW"), (S.FlipX = "flipX"), (S.FlipY = "flipY"), S),
			...
			ea = (e, n = {}, o = {}) => {
				...
				function C() {
					...
					l && (l.setAttribute("width", t + ""), l.setAttribute("height", n + "")),
						...
						(f = F()
							.on("start", (e, t) => {
								(w = { ...ee, ...t }), void 0 !== t.angle && (t.angle = 90 * Math.round(t.angle / 90)), void 0 !== t.flipX && (t.flipX = t.flipX > 0 ? 1 : -1), void 0 !== t.flipY && (t.flipY = t.flipY > 0 ? 1 : -1), W(), S("animationStart");
							})
							.on("pause", (e) => {
								w = { ...ee, ...e };
							})
				...
				function O() {
					...
					if (i) {
						...
						w.angle % 180 == 90 ? ((e.top = t.top + 0.5 * t.height - 0.5 * t.width), (e.left = t.left + 0.5 * t.width - 0.5 * t.height), (e.width = t.height), (e.height = t.width)) : ((e.top = t.top), (e.left = t.left), (e.width = t.width), (e.height = t.height));
					}
					return e;
				}
				function A() {
					...
					if (l && "auto" === t) {
						...
						t = e ? parseFloat(e + "") : void 0 !== l.dataset.height ? parseFloat(l.dataset.height + "") : c instanceof HTMLImageElement ? c.naturalHeight : l instanceof HTMLImageElement ? l.naturalHeight : l.getBoundingClientRect().height;
				...
				function q(t) {
					...
					return (r *= c), (s *= u), t > 1 && (r > l && ((n.x[0] = (l - r) * 0.5), (n.x[1] = (r - l) * 0.5)), (n.x[0] -= (i.left - o.left) * 0.5), (n.x[1] -= (i.left - o.left) * 0.5), (n.x[0] -= (i.left + i.width - o.right) * 0.5), (n.x[1] -= (i.left + i.width - o.right) * 0.5), s > a && ((n.y[0] = (a - s) * 0.5), (n.y[1] = (s - a) * 0.5)), (n.y[0] -= (i.top - o.top) * 0.5), (n.y[1] -= (i.top - o.top) * 0.5), (n.y[0] -= (i.top + i.height - o.bottom) * 0.5), (n.y[1] -= (i.top + i.height - o.bottom) * 0.5)), n;
				}
				function B() {
					...
					switch (t) {
						...
						case J.MoveDown:
							if (d?.isPointerDown()) {
								let e = 1,
									t = 1;
								w.x <= i.x[0] && c <= 0 && (e = 0.2 * Math.max(0.01, 1 - Math.abs((1 / r.width) * Math.abs(w.x - i.x[0])))), w.x >= i.x[1] && c >= 0 && (e = 0.2 * Math.max(0.01, 1 - Math.abs((1 / r.width) * Math.abs(w.x - i.x[1])))), w.y <= i.y[0] && u <= 0 && (t = 0.2 * Math.max(0.01, 1 - Math.abs((1 / r.height) * Math.abs(w.y - i.y[0])))), w.y >= i.y[1] && u >= 0 && (t = 0.2 * Math.max(0.01, 1 - Math.abs((1 / r.height) * Math.abs(w.y - i.y[1])))), (w.x += m * e), (w.y += h * t);
				...
				function Y() {
					...
					if (i && d) {
						...
						1 !== l || 1 !== r ? (s += ` scaleX(${K(i * l)}) scaleY(${K(i * r)})`) : (s += ` scale(${K(i)})`), 0 !== a && (s += ` rotate(${a}deg)`), c && ((c.style.width = `${K(n)}px`), (c.style.height = `${K(o)}px`), (c.style.transform = `${s}`));
					}
					S("render");
				}
				function Q() {
				...
				let ep = {
					...
					destroy: function () {
						...
						for (let e of x) e();
						return i && ((i.style.aspectRatio = ""), (i.style.maxWidth = ""), (i.style.maxHeight = "")), c && ((c.style.width = ""), (c.style.height = ""), (c.style.transform = "")), (i = void 0), (l = void 0), (c = void 0), (E = { ...ee }), (w = { ...ee }), f?.destroy(), (f = void 0), d?.destroy(), (d = void 0), (v = et.Destroyed), ep;
					},
					emit: S,
					execute: Z,
					getBoundaries: q,
					...
					init: function () {
						return (
							...
							(function () {
								...
								if ((h(e, t.container), (l = e.querySelector("." + t.content))) && (l.setAttribute("draggable", "false"), (i = e.querySelector("." + t.wrapper)) || (h((i = document.createElement("div")), t.wrapper), l.insertAdjacentElement("beforebegin", i), i.insertAdjacentElement("afterbegin", l)), l instanceof HTMLImageElement || l instanceof HTMLPictureElement)) {
		...
		let er = (e, t) => {
			...
			eh = (e, t = {}, o = {}) => {
												...
												(e = requestAnimationFrame(() => {
													(function (e) {
														...
														let n = x.getBoundingClientRect(),
															o = n.height,
															l = n.width;
														if (!(t > 1 && ((R && 0.5 > Math.abs(o - N)) || (!R && 0.5 > Math.abs(l - q))))) (N = o), (q = l), (!R || o) && (R || l) && x && M && ((t === j.length && i?.isPointerDown()) || (B("dragFree") && (S || (C > k && C < I)) ? (Q(), eC()) : eP(A, { transition: !1 })));
													})(t),
														(e = null);
												}));
										})).observe(x);
				...
				function eE() {
					...
					let e = B("classes");
					ec(x, e.isLTR, !T), ec(x, e.isRTL, T), ec(x, e.isHorizontal, !R), ec(x, e.isVertical, R), ec(x, e.hasAdaptiveHeight, B("adaptiveHeight")), (L = "visible" === window.getComputedStyle(M).getPropertyValue("overflow-" + (R ? "y" : "x")));
				...
				function eR(e) {
					...
					!i && n instanceof HTMLElement && n.classList.contains("f-caption") && (i = n), !i && (h((i = document.createElement("div")), "f-caption"), a(n) ? (i.innerHTML = W(n + "")) : n instanceof HTMLElement && (n.parentElement && (n = n.cloneNode(!0)), i.append(n)));
				...
				function eP(e, t) {
					...
					if (
						...
						(function (e, t) {
							...
							let d = ev(i),
								f = ev(r);
							return Q(), d && (H.add(l), (d.style.transform = ""), d.addEventListener("animationend", eM), es(d, E.classes.isSelected), h(d, `f-${t}Out to-${o > 0 ? "next" : "prev"}`)), f && (H.add(s), (f.style.transform = ""), f.addEventListener("animationend", eM), h(f, E.classes.isSelected), h(f, `f-${t}In from-${o > 0 ? "prev" : "next"}`)), eC(), !0;
						})(e, n)
					)
						return;
				...
				function eO() {
					for (let e of (x?.removeEventListener("click", eL), ex(), document.removeEventListener("mousemove", U), d?.disconnect(), (d = void 0), _)) e.el && r(e.el) && ((e.state = void 0), eS(e), eT(e), ey(e), e.isVirtual ? (e.el?.remove(), (e.el = void 0)) : ((e.el.style.transform = ""), M?.appendChild(e.el)));
    ...
    data-lazy-src="{{src}}" alt="{{alt}}" />`,
			...
			ew = () => {
				...
				return {
					...
					destroy: function () {
						e?.off("ready", i), e?.off("refresh", u), e?.off("change", a), e?.off("click", s), e?.getViewport()?.removeEventListener("mouseover", c), t?.off("change", r), t?.off("filter", d), (t = void 0), e?.off("initSlides", o), (e = void 0);
					},
					getTarget: function () {
						return t;
					},
			...
			eI = () => {
				...
				function d() {
					...
					let t = e?.getContainer();
					t && r("pauseOnHover") && matchMedia("(hover: hover)").matches && (t.addEventListener("mouseenter", E, !1), t.addEventListener("mouseleave", w, !1)), e.on("change", v), e.on("settle", y), e.on("contentReady", m), e.on("panzoom:animationStart", f), e.isSettled() && u();
				}
				function f() {
					if ((c(), g(), n && e)) {
			...
			e_ = () => {
				...
				function L() {
					...
					for (let t of n) {
						...
						(l = Math.max(-1, Math.min(1, l))) > -1 && l < 1 && (o += 0.5 * i * (1 - Math.abs(l))), (l = Math.round(1e4 * l) / 1e4), (o = Math.round(1e4 * o) / 1e4), n.style.setProperty("--progress", `${Math.abs(l)}`), n.style.setProperty("--shift", `${e?.isRTL() ? -1 * o : o}px`), l > -1 && l < 1 && (o += 0.5 * i * (1 - Math.abs(l)));
					}
				}
				return {
					init: function (t, n) {
					...
					destroy: function () {
						e?.off("ready", y), e?.off("initSlides", v), e?.off("render", E), e?.off("change", w), e?.off("addSlide", x), e?.off("click", M), e?.getGestures()?.off("start", b), e?.getContainer()?.classList.remove("has-thumbs"), (e = void 0), t?.destroy(), (t = void 0), n?.remove(), (n = void 0);
					},
    ...
    <div class="fancybox__container" tabindex="0" aria-label="{{MODAL}}">
      ...
      <div class="fancybox__carousel"></div>
										...
										o.onreadystatechange = function () {
											if (o.readyState === XMLHttpRequest.DONE && g === e4.Ready)
												if ((e?.hideLoading(t), (t.state = eg.Loaded), 200 === o.status)) {
													...
													a && a instanceof HTMLElement ? (l = a) : ((l = document.createElement("div")).innerHTML = i), l.classList.add("f-html"), (t.htmlEl = l), n.classList.add("has-html"), n.classList.add("has-ajax"), n.prepend(l), e?.emit("contentReady", t);
												} else e?.showError(t);
										};
										let i = M("ajax") || null;
									...
									!(function (t = [], n = {}) {
										...
										if (
											...
											(function () {
												...
												if (!(t && t instanceof HTMLElement) || !((o = s(L(M("mainTpl") || "")) || void 0) && o instanceof HTMLDialogElement) || !((i = o.querySelector(".fancybox__container")) && i instanceof HTMLElement)) return;
												let n = M("mainClass");
												n && h(i, n);
												let a = M("mainStyle");
		...
		(e.Arrows = eR), (e.Autoplay = eI), (e.Carousel = eh), (e.CarouselSlideContentState = eg), (e.CarouselState = ef), (e.Fancybox = e9), (e.FancyboxState = e4), (e.Fullscreen = eB), (e.Html = eD), (e.Lazyload = eS), (e.PANZOOM_DEFAULT_POS = ee), (e.Panzoom = ea), (e.PanzoomAction = J), (e.PanzoomState = et), (e.PanzoomZoomLevel = Q), (e.Sync = ew), (e.Thumbs = e_), (e.Toolbar = ez), (e.ToolbarColumn = eC), (e.Video = ej), (e.Zoomable = eb);
	})
);
